...
export default function CareerAdvisorExperiencedPage() {
  return (
        ...
        <div className="relative w-full h-[40vh] overflow-hidden">
          ...
          <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
            <div className="text-center text-white max-w-4xl px-4">
              <h1 className="text-3xl md:text-5xl font-bold mb-4 font-heading">キャリアアドバイザー（経験者）</h1>
            </div>
          </div>
        </div>
              ...
              <div className="p-6 md:p-8">
                <div className="flex flex-col md:flex-row gap-8 mb-12">
                  ...
                  <div className="w-full md:w-1/2">
                    ...
                    <div className="bg-secondary/30 p-4 rounded-none">
                      <p className="text-xl font-medium mb-2">月給33万円～</p>
